                ...
                <tbody>
                    ...
                    foreach ($a as $b) {
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?= base_url('Simpenghulu/KUA/Detail?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $b->kua_city_id . '&b=' . $b->city_title . '&c=' . $param[0] . '&d=' . $param[1]))); ?>" class="btn btn-icon btn-default btn-xs" title="Detail <?= $b->city_title; ?>"><i class="fas fa-eye"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
