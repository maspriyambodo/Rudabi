                    ...
                    foreach ($b as $key => $c) {
                        ...
                        <tr>
                            <td style="text-align:left !important;">
                                ...
                                echo '<a href="' . base_url('Simpenghulu/Nikah_Rujuk/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt($q))) . '" title="Detail Provinsi ' . $c->province_title . '">' . $c->province_title . '</a>';
                                ?>
                            </td>
...
<script>
    function Tahun() {
        ...
        return window.location.href = "Simpenghulu/Nikah_Rujuk/index?key=" + a;
    }
