...
class Penghulu extends CI_Controller {
    ...
    public function index() {
        $data = [
            ...
            'data' => read_file('https://simas.kemenag.go.id/rudabi/datapi/simpenghulu/penghulu?KEY=boba')
        ];
        $data['content'] = $this->parser->parse('Penghulu_index', $data, true);
    ...
    public function Kabupaten() {
        ...
        $data['content'] = $this->parser->parse('Penghulu_Kabupaten', $data, true);
        return $this->parser->parse('Dashboard/Template', $data);
    }
    ...
    public function Detail() {
        ...
        $data = [
            ...
            'username' => $this->session->userdata('username'),
            'param' => $param,
            'data' => read_file('https://simas.kemenag.go.id/rudabi/datapi/simpenghulu/penghulu?KEY=boba&city_id=' . $param[0])
        ];
        $data['content'] = $this->parser->parse('Penghulu_Detail', $data, true);
        return $this->parser->parse('Dashboard/Template', $data);
    }
