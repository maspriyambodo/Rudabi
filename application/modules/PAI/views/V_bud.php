<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-2">
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Data Budayawan tahun <?= date('Y'); ?></h5>
        </div>
    </div>
</div>
...
<script>
    window.onload = function () {
        var url = "https://simas.kemenag.go.id/rudabi/datapi/simpenaiss/budayawan?KEY=BOBA";
        $('table').dataTable({
            "ServerSide": true,
            "order": [[0, "asc"]],
            "paging": false,
            ...
            columns: [
                {
                    ...
                    render: function (data) {
                        ...
                        c = b.replace(' ', '_');
                        return '<a href="<?= base_url('PAI/Budayawan/Provinsi/'); ?>' + a + "/" + c + '">' + b + '</a>';
                    }
                },
                {data: "jum_bdymuslim", className: "text-center sum_haf"},
                {data: "muslim_pria", className: "text-center sum_pria"},
                {data: "muslim_perempuan", className: "text-center sum_wan"},
                {data: "muslim_kawin", className: "text-center muslim_kawin"},
                {data: "muslim_belum_kawin", className: "text-center muslim_blmkawin"}
            ],
            footerCallback: function () {
                ...
                api.columns('.sum_haf', {page: 'all'}).every(function () {
                    ...
                    document.getElementById('jumlah_bdymuslim').innerHTML = "<b>Jumlah Budayawan " + numFormat(sum) + "</b>";
                ...
                api.columns('.muslim_kawin', {page: 'all'}).every(function () {
                    var sum = this
                            .data()
                            .reduce(function (a, b) {
                                var x = parseFloat(a) || 0;
                ...
                api.columns('.muslim_blmkawin', {page: 'all'}).every(function () {
                    var sum = this
                            .data()
                            .reduce(function (a, b) {
                                var x = parseFloat(a) || 0;
