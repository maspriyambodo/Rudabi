<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-2">
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5 text-uppercase">data Penulis provinsi {provinsi}</h5>
        </div>
    </div>
</div>
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            <a href="<?= base_url('PAI/Penulis/index/'); ?>" class="btn btn-light btn-shadow-hover"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
    </div>
    <div class="card-body">
...
<script>
    window.onload = function () {
        var url = "https://simas.kemenag.go.id/rudabi/datapi/simpenaiss/penulis?KEY=BOBA&province_id=<?= $id; ?>";
        $('table').dataTable({
            "ServerSide": true,
            "order": [[0, "asc"]],
            "paging": true,
            ...
            columns: [
                {
                    ...
                    render: function (data) {
                        ...
                        b = data.city_title;
                        c = b.replace(' ', '_');
                        return '<a href="<?= base_url('PAI/Penulis/Kabupaten/'); ?>' + a + "/" + c + '">' + b + '</a>';
                    }
                },
                {data: "jumlah_penulis", className: "text-center sum_haf"},
            ...
            footerCallback: function () {
                ...
                api.columns(['.sum_haf', '.sum_smp', '.sum_sma', '.sum_pes', '.sum_d1', '.sum_d2', '.sum_d3', '.sum_s1', '.sum_s2', '.sum_s3'], {page: 'all'}).every(function () {
                    var sum = this
                            .data()
                            .reduce(function (a, b) {
        ...
        a = document.getElementsByClassName('sum_haf')[2].innerText;
        b = document.getElementsByClassName('sum_smp')[2].innerText;
        c = document.getElementsByClassName('sum_sma')[2].innerText;
        d = document.getElementsByClassName('sum_pes')[2].innerText;
        e = document.getElementsByClassName('sum_d1')[2].innerText;
        f = document.getElementsByClassName('sum_d2')[2].innerText;
        g = document.getElementsByClassName('sum_d3')[2].innerText;
        h = document.getElementsByClassName('sum_s1')[2].innerText;
        i = document.getElementsByClassName('sum_s2')[2].innerText;
        j = document.getElementsByClassName('sum_s3')[2].innerText;
        document.getElementById('jumlah_bdymuslim').innerHTML = "<b>Jumlah Penulis " + a + "</b>";
        am4core.ready(function () {
            ...
            valueAxis.title.text = "Jumlah Penulis";
            valueAxis.title.fontWeight = 800;
            var series = chart.series.push(new am4charts.ColumnSeries());
            series.dataFields.valueY = "jumlah_penulis";
        ...
        am4core.ready(function () {
            ...
            var valueAxis = chart.yAxes.push(new am4charts.ValueAxis());
            valueAxis.renderer.minWidth = 100;
            valueAxis.title.text = "Jumlah Pendidikan Penulis";
            valueAxis.title.fontWeight = 800;
            var series = chart.series.push(new am4charts.ColumnSeries());
