            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody class="text-center">
                    ...
                    foreach ($a as $b) {
                        ...
                        ?>
                        <tr>
                            <td style="text-align: left !important;"><?php echo '<a href="' . base_url('PAI/Hafiz/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $b->province_id . '&b=' . $b->province_title))) . '" title="Detail Provinsi ' . $b->province_title . '">' . $b->province_title . '</a>'; ?></td>
