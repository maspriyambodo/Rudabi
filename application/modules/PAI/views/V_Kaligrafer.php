<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-2">
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Data Kaligrafer tahun <?= date('Y'); ?></h5>
        </div>
    </div>
</div>
...
<script>
    window.onload = function () {
        var url = "https://simas.kemenag.go.id/rudabi/datapi/simpenaiss/kaligrafer?KEY=BOBA";
        $('table').dataTable({
            "ServerSide": true,
            "order": [[0, "asc"]],
            "paging": false,
            ...
            columns: [
                {
                    ...
                    render: function (data) {
                        ...
                        c = b.replace(' ', '_');
                        return '<a href="<?= base_url('PAI/Kaligrafer/Provinsi/'); ?>' + a + "/" + c + '">' + b + '</a>';
                    }
                },
                {data: "jum_kaligrafer", className: "text-center sum_haf"},
                {data: "klgf_pria", className: "text-center sum_pria"},
                {data: "klgf_perempuan", className: "text-center sum_wan"},
                {data: "klgf_kawin", className: "text-center hafiz_kawin"},
                {data: "klgf_belum_kawin", className: "text-center hafiz_blmkawin"}
            ],
            footerCallback: function () {
                ...
                api.columns('.sum_haf', {page: 'all'}).every(function () {
                    ...
                    document.getElementById('jumlah_hafiz').innerHTML = "<b>Jumlah kaligrafer " + numFormat(sum) + "</b>";
        ...
        am4core.ready(function () {
            ...
            series.tooltipText = "Jumlah kaligrafer di {categoryX}: [bold]{valueY}[/]";
