    ...
    window.onload = function () {
        $('table').dataTable({
            ...
            columns: [
                ...
                {data: "penyuluh_pns_jenis_kelamin", className: "text-center"},
                {data: "penyuluh_pns_tempat_lahir", className: "text-center"},
                {data: "penyuluh_pns_tgl_lahir", className: "text-center"},
                {data: "penyuluh_pns_status_kawin", className: "text-center"},
                {data: "penyuluh_pns_alamat"}
            ]
        });
    };
