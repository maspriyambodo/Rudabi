<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-2">
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Data Seniman Islam tahun <?= date('Y'); ?></h5>
        </div>
    </div>
</div>
    ...
    <div class="card-header">
        <div class="card-title">
            <div class="text-uppercase">
                data Seniman Islam per provinsi
            </div>
        </div>
    </div>
    <div class="card-body">
...
<script>
    window.onload = function () {
        var url = "https://simas.kemenag.go.id/rudabi/datapi/simpenaiss/seniman?KEY=BOBA";
        $('table').dataTable({
            "ServerSide": true,
            "order": [[0, "asc"]],
            "paging": false,
            ...
            columns: [
                {
                    ...
                    render: function (data) {
                        ...
                        c = b.replace(' ', '_');
                        return '<a href="<?= base_url('PAI/Seniman/Provinsi/'); ?>' + a + "/" + c + '">' + b + '</a>';
                    }
                },
                {data: "jum_seniman", className: "text-center sum_haf"},
                {data: "snmn_pria", className: "text-center sum_pria"},
                {data: "snmn_perempuan", className: "text-center sum_wan"},
                {data: "snmn_kawin", className: "text-center snmn_kawin"},
                {data: "snmn_belum_kawin", className: "text-center snmn_blmkawin"}
            ],
            footerCallback: function () {
                ...
                api.columns('.sum_haf', {page: 'all'}).every(function () {
                    ...
                    document.getElementById('jumlah_hafiz').innerHTML = "<b>Jumlah Seniman " + numFormat(sum) + "</b>";
                ...
                api.columns('.snmn_kawin', {page: 'all'}).every(function () {
                    var sum = this
                            .data()
                            .reduce(function (a, b) {
                                var x = parseFloat(a) || 0;
                ...
                api.columns('.snmn_blmkawin', {page: 'all'}).every(function () {
                    var sum = this
                            .data()
                            .reduce(function (a, b) {
                                var x = parseFloat(a) || 0;
