            ...
            <table class="table table-bordered table-hover table-striped" style="width:100%;">
                ...
                <tbody class="text-center text-uppercase">
                    ...
                    foreach ($a as $b) {
                        ...
                        ?>
                        <tr>
                            <td style="text-align:left !important;"><?php echo '<a href="' . base_url('PAI/N_pns/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $b->penyuluh_nonpns_provinsi . '&b=' . $b->province_title))) . '" title="Detail Provinsi ' . $b->province_title . '">' . $b->province_title . '</a>'; ?></td>
