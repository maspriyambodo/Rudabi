...
<script>
    window.onload = function () {
        var url = "https://simas.kemenag.go.id/rudabi/datapi/simpenaiss/budayawan?KEY=BOBA&province_id=<?= $id; ?>";
        $('table').dataTable({
            "ServerSide": true,
            "order": [[0, "asc"]],
            "paging": true,
            ...
            columns: [
                {
                    ...
                    render: function (data) {
                        ...
                        b = data.city_title;
                        c = b.replace(' ', '_');
                        return '<a href="<?= base_url('PAI/Budayawan/Kabupaten/'); ?>' + a + "/" + c + '">' + b + '</a>';
                    }
                },
            ...
            footerCallback: function () {
                ...
                api.columns('.sum_haf', {page: 'all'}).every(function () {
                    ...
                    document.getElementById('jumlah_bdymuslim').innerHTML = "<b>Jumlah Hafidz " + numFormat(sum) + "</b>";
