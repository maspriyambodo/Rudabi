<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-2">
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Data Penulis Islam tahun <?= date('Y'); ?></h5>
        </div>
    </div>
</div>
    ...
    <div class="card-header">
        <div class="card-title">
            <div class="text-uppercase">
                data Penulis Islam per provinsi
            </div>
        </div>
    </div>
    <div class="card-body">
        <div id="jumlah_penulis" class="text-center"></div>
...
<script>
    window.onload = function () {
        var url = "https://simas.kemenag.go.id/rudabi/datapi/simpenaiss/penulis?KEY=BOBA";
        $('table').dataTable({
            "ServerSide": true,
            "order": [[0, "asc"]],
            "paging": false,
            ...
            columns: [
                {
                    ...
                    render: function (data) {
                        ...
                        c = b.replace(' ', '_');
                        return '<a href="<?= base_url('PAI/Penulis/Provinsi/'); ?>' + a + "/" + c + '">' + b + '</a>';
                    }
                },
                {data: "jum_penulis", className: "text-center sum_pen"},
                {data: "penulis_pria", className: "text-center sum_pria"},
                {data: "penulis_perempuan", className: "text-center sum_perem"},
                {data: "penulis_kawin", className: "text-center sum_kwn"},
                {data: "penulis_belum_kawin", className: "text-center sum_blm"}
            ],
            footerCallback: function () {
                var api = this.api();
                var numFormat = $.fn.dataTable.render.number('\.', '', 0, '').display;
                api.columns(['.sum_pen', '.sum_pria', '.sum_perem', '.sum_kwn', '.sum_blm'], {page: 'all'}).every(function () {
                    var sum = this
                            .data()
                            .reduce(function (a, b) {
        ...
        var jumlah_penulis = document.getElementsByClassName('sum_pen')[2].innerText;
        var jumlah_pria = document.getElementsByClassName('sum_pria')[2].innerText;
        var jumlah_wan = document.getElementsByClassName('sum_perem')[2].innerText;
        var jumlah_kwn = document.getElementsByClassName('sum_kwn')[2].innerText;
        var jumlah_blm = document.getElementsByClassName('sum_blm')[2].innerText;
        document.getElementById('jumlah_penulis').innerHTML = "<b>Jumlah Penulis Islam " + jumlah_penulis + "</b>";
        am4core.ready(function () {
            ...
            series.tooltipText = "Jumlah Penulis Islam di {categoryX}: [bold]{valueY}[/]";
