<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-2">
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Data Mufassir tahun <?= date('Y'); ?></h5>
        </div>
    </div>
</div>
...
<script>
    window.onload = function () {
        var url = "https://simas.kemenag.go.id/rudabi/datapi/simpenaiss/mufassir?KEY=BOBA";
        $('table').dataTable({
            "ServerSide": true,
            "order": [[0, "asc"]],
            "paging": false,
            ...
            columns: [
                {
                    ...
                    render: function (data) {
                        ...
                        c = b.replace(' ', '_');
                        return '<a href="<?= base_url('PAI/Mufassir/Provinsi/'); ?>' + a + "/" + c + '">' + b + '</a>';
                    }
                },
                {data: "jum_mufassir", className: "text-center sum_haf"},
                {data: "mufassir_pria", className: "text-center sum_pria"},
                {data: "mufassir_perempuan", className: "text-center sum_wan"},
                {data: "mufassir_kawin", className: "text-center hafiz_kawin"},
                {data: "mufassir_belum_kawin", className: "text-center hafiz_blmkawin"}
            ],
