<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-2">
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Data Guru Ngaji tahun <?= date('Y'); ?></h5>
        </div>
    </div>
</div>
...
<input type="hidden" name="wanitatxt"/>
    ...
    window.onload = function () {
            ...
            columns: [
                {
                    data: null, render: function (data) {
                        ...
                        c = b.replace(' ', '_');
                        return '<a href="<?= base_url('PAI/Guru_ngaji/Provinsi/'); ?>' + a + "/" + c + '">' + b + '</a>';
                    }
                },
                {data: "jum_tokoh", className: "text-center sum_to"},
                {data: "tokoh_pria", className: "text-center sum_de"},
                {data: "tokoh_perempuan", className: "text-center sum_sunda"},
                {data: "tokoh_kawin", className: "text-center sum_jawa"},
                {data: "tokoh_belum_kawin", className: "text-center sum_suma"}
            ],
            footerCallback: function () {
                var api = this.api();
                var numFormat = $.fn.dataTable.render.number('\.', '', 0, '').display;
                api.columns('.sum_to', {page: 'all'}).every(function () {
                    var sum = this
                            .data()
                            .reduce(function (a, b) {
                    ...
                    document.getElementById('jumlah_dewan').innerHTML = "<b>Jumlah Guru Ngaji " + numFormat(sum) + "</b>";
                    $(this.footer()).html(numFormat(sum));
                });
                api.columns('.sum_de', {page: 'all'}).every(function () {
                    var sum = this
                            .data()
                            .reduce(function (a, b) {
                                var x = parseFloat(a) || 0;
                ...
                api.columns('.sum_sunda', {page: 'all'}).every(function () {
                    var sum = this
                            .data()
                            .reduce(function (a, b) {
                                var x = parseFloat(a) || 0;
                    ...
                    $('input[name=wanitatxt]').val(numFormat(sum));
                    $(this.footer()).html(numFormat(sum));
                });
                api.columns('.sum_jawa', {page: 'all'}).every(function () {
                    var sum = this
                            .data()
                            .reduce(function (a, b) {
                                var x = parseFloat(a) || 0;
                ...
                api.columns('.sum_suma', {page: 'all'}).every(function () {
                    var sum = this
                            .data()
                            .reduce(function (a, b) {
                                var x = parseFloat(a) || 0;
        ...
        am4core.ready(function () {
            ...
            var data = [
                ...
                {
                    city_title: "laki-laki",
                    jum_dewan: b
                },
                {
                    city_title: "perempuan",
                    jum_dewan: c
                },
                {
                    city_title: "kawin",
            ...
            series1.dataFields.value = "jum_dewan";
            ...
            series2.dataFields.value = "jum_dewan";
