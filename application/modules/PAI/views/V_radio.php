            ...
            <table class="table table-bordered table-hover table-striped" style="width:100%;">
                ...
                <tbody class="text-center">
                    ...
                    foreach ($a as $b) {
                        ...
                        ?>
                        <tr>
                            <th style="text-align: left !important;"><?php echo '<a href="' . base_url('PAI/Radio_Islam/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $b->province_id . '&b=' . $b->province_title))) . '" title="Detail Provinsi ' . $b->province_title . '">' . $b->province_title . '</a>'; ?></th>
...
<script>
    window.onload = function () {
        ...
        am4core.ready(function () {
            ...
            chart.data = [
                {
                    country: "Geografi Kota",
                    litres: d
                },
                {
                    country: "Geografi Terisolir",
                    litres: g
                },
                {
                    country: "Geografi Desa",
                    litres: e
                },
                {
                    country: "Geografi Pelosok",
                    litres: f
                }
            ];
            var series = chart.series.push(new am4charts.PieSeries3D());
