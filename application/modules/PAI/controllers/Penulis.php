...
class Penulis extends CI_Controller {
    ...
    public function index() {
        $data = [
            ...
            'data' => $this->bodo->Curel($this->bodo->Url_API() . 'simpenaiss/penulis?KEY=BOBA')
        ];
    ...
    public function Provinsi() {
        ...
        $data = [
            ...
            'username' => $this->Authentication[0]->uname,
            'data' => $this->bodo->Curel($this->bodo->Url_API() . 'simpenaiss/penulis?KEY=BOBA&province_id=' . $param[0]),
            'param' => $param
        ];
    ...
    public function Kabupaten() {
        ...
        $data = [
            ...
            'username' => $this->Authentication[0]->uname,
            'data' => $this->bodo->Curel($this->bodo->Url_API() . 'simpenaiss/penulis?KEY=BOBA&city_id=' . $param[2]),
            'param' => $param
        ];
