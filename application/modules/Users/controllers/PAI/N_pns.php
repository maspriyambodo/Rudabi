...
class N_pns extends CI_Controller {
    ...
    public function index() {
        $data = [
            ...
            'data' => $this->bodo->Curel('https://simas.kemenag.go.id/rudabi/datapi/simpenaiss/datanonpns?KEY=boba')
        ];
        $data['content'] = $this->parser->parse('Users/u_pai/Nonpns_index', $data, true);
    ...
    public function Provinsi() {
        ...
        $data = [
            ...
            'username' => $this->Authentication[0]->uname,
            'data' => $this->bodo->Curel('https://simas.kemenag.go.id/rudabi/datapi/simpenaiss/datanonpns?KEY=boba&penyuluh_nonpns_provinsi=' . $param[0]),
            'param' => $param
        ];
        $data['content'] = $this->parser->parse('Users/u_pai/Nonpns_provinsi', $data, true);
        return $this->parser->parse('Users/u_pai/Template', $data);
    }
