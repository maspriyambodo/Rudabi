...
class Pns extends CI_Controller {
    ...
    public function index() {
        $data = [
            ...
            'data' => read_file('https://simas.kemenag.go.id/rudabi/datapi/simpenaiss/datapns?KEY=boba')
        ];
        $data['content'] = $this->parser->parse('Users/u_pai/Penyuluh_pns', $data, true);
    ...
    public function Provinsi() {
        ...
        $data = [
            ...
            'username' => $this->Authentication[0]->uname,
            'data' => read_file('https://simas.kemenag.go.id/rudabi/datapi/simpenaiss/datapns?KEY=boba&penyuluh_pns_provinsi=' . $param[0]),
            'param' => $param
        ];
        $data['content'] = $this->parser->parse('Users/u_pai/Penyuluh_provinsi', $data, true);
        return $this->parser->parse('Users/u_pai/Template', $data);
    }
