...
class Pensiun extends CI_Controller {
    ...
    public function index() {
        ...
        $data['content'] = $this->parser->parse('Sek/index', $data, true);
    ...
    public function Provinsi() {
        ...
        $data['content'] = $this->parser->parse('Sek/Provinsi', $data, true);
        return $this->parser->parse('Sek/Template', $data);
    }
    ...
    public function Kabupaten() {
        ...
        $data = [
            ...
            'username' => $this->session->userdata('username'),
            'param' => $param,
            'data' => read_file('https://simas.kemenag.go.id/rudabi/datapi/sicakepp/pensiun?KEY=boba&kab_id=' . $param[0])
        ];
        $data['content'] = $this->parser->parse('Sek/V_Kabupaten', $data, true);
        return $this->parser->parse('Sek/Template', $data);
    }
    ...
    public function Golongan() {
        ...
        $data = [
            ...
            'username' => $this->session->userdata('username'),
            'param' => $param,
            'data' => read_file('https://simas.kemenag.go.id/rudabi/datapi/sicakepp/pensiun?KEY=boba&kab_id=' . $param[0] . '&item_id=' . $param[2] . '')
        ];
        $data['content'] = $this->parser->parse('Sek/Golongan', $data, true);
        return $this->parser->parse('Sek/Template', $data);
    }
