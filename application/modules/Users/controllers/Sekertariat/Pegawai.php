...
class Pegawai extends CI_Controller {
    ...
    public function index() {
        ...
        $data['content'] = $this->parser->parse('Sek/Pegawai_index', $data, true);
    ...
    public function Provinsi() {
        ...
        $data['content'] = $this->parser->parse('Sek/Pegawai_provinsi', $data, true);
        return $this->parser->parse('Sek/Template', $data);
    }
    ...
    public function Kabupaten() {
        ...
        $data['content'] = $this->parser->parse('Sek/Pegawai_Kabupaten', $data, true);
        return $this->parser->parse('Sek/Template', $data);
    }
    ...
    public function Detail() {
        ...
        $data['content'] = $this->parser->parse('Sek/Pegawai_Detail', $data, true);
        return $this->parser->parse('Sek/Template', $data);
    }
