...
class Approved extends CI_Controller {
    ...
    public function index($year) {
        ...
        $data['content'] = $this->parser->parse('Sek/Approved_index', $data, true);
    ...
    public function Provinsi() {
        ...
        $data['content'] = $this->parser->parse('Sek/Approved_Provinsi', $data, true);
        return $this->parser->parse('Sek/Template', $data);
    }
    ...
    public function Kabupaten() {
        ...
        $data['content'] = $this->parser->parse('Sek/Approved_Kabupaten', $data, true);
        return $this->parser->parse('Sek/Template', $data);
    }
