...
class Siwak extends CI_Controller {
    ...
    public function index() {
        $data = [
            ...
            'data' => read_file('https://simas.kemenag.go.id/rudabi/datapi/siwaks/tanahwakaf?KEY=boba')
        ];
        $data['content'] = $this->parser->parse('Users/u_siwak/Siwak_index', $data, true);
    ...
    public function Provinsi() {
        ...
        $data = [
            ...
            'username' => $this->Authentication[0]->uname,
            'data' => read_file('https://simas.kemenag.go.id/rudabi/datapi/siwaks/tanahwakaf?KEY=boba&Lokasi_Prop=' . $param[0]),
            'param' => $param
        ];
        $data['content'] = $this->parser->parse('Users/u_siwak/Siwak_Provinsi', $data, true);
        return $this->parser->parse('Users/u_siwak/Template', $data);
    }
    ...
    public function Kabupaten() {
        ...
        $data = [
            'title' => 'Data Wakaf Provinsi ' . $param[1] . '| RUDABI SYSTEM OF KEMENAG RI',
            'username' => $this->Authentication[0]->uname,
            'data' => read_file('https://simas.kemenag.go.id/rudabi/datapi/siwaks/tanahwakaf?KEY=boba&lokasi_kode=' . $param[2]),
            'param' => $param
        ];
        $data['content'] = $this->parser->parse('Users/u_siwak/Siwak_Kabupaten', $data, true);
        return $this->parser->parse('Users/u_siwak/Template', $data);
    }
    ...
    public function Kecamatan() {
        ...
        $data = [
            'title' => 'Data Wakaf Provinsi ' . $param[1] . '| RUDABI SYSTEM OF KEMENAG RI',
            'username' => $this->Authentication[0]->uname,
            'data' => read_file('https://simas.kemenag.go.id/rudabi/datapi/siwaks/tanahwakaf?KEY=boba&lokasi_ID=' . $param[4]),
            'param' => $param
        ];
        $data['content'] = $this->parser->parse('Users/u_siwak/Siwak_Kecamatan', $data, true);
        return $this->parser->parse('Users/u_siwak/Template', $data);
    }
