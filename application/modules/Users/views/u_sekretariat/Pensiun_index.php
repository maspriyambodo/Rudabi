                ...
                <tbody>
                    <?php foreach ($pensiun as $pensiun_r) { ?>
                        <tr>
                            <td>
                                <?php
                                echo '<a href="' . base_url('Users/Sekretariat/Pensiun/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $pensiun_r->peg_provinsi . '&b=' . $pensiun_r->propinsi_nama))) . '" title="Detail Provinsi ' . $pensiun_r->propinsi_nama . '">' . $pensiun_r->propinsi_nama . '</a>';
                                ?>
                            </td>
