                ...
                <tbody>
                    ...
                    foreach ($input as $input) {
                        ...
                        <tr>
                            <td>
                                <?php
                                echo '<a href=' . base_url('Users/Sekretariat/Input/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $param[0] . '&b=' . $input->usul_propinsi . '&c=' . $input->propinsi_nama))) . '>' . $input->propinsi_nama . '</a>';
                                ?>
                            </td>
...
<script>
    function Tahun() {
        ...
        return window.location.href = "Users/Sekretariat/Input/index?key=" + a;
    }
