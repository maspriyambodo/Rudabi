                ...
                <tbody>
                    <?php foreach ($pegawai as $pegawai) { ?>
                        <tr>
                            <td>
                                <?php
                                echo '<a href="' . base_url('Users/Sekretariat/Pegawai/Kabupaten?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $pegawai->kab_nama . '&b=' . $pegawai->peg_kabupaten . '&c=' . $param[0] . '&d=' . $param[1]))) . '">' . $pegawai->kab_nama . '</a>';
                                ?>
                            </td>
