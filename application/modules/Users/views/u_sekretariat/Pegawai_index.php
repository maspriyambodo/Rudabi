            ...
            <table class="table table-bordered table-hover table-striped" style="width:100%;">
                ...
                <tbody>
                    <?php foreach ($pegawai as $pegawai) { ?>
                        <tr>
                            <td>
                                <?php echo '<a href="' . base_url('Users/Sekretariat/Pegawai/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $pegawai->propinsi_nama . '&b=' . $pegawai->peg_provinsi))) . '">' . $pegawai->propinsi_nama . '</a>'; ?>
                            </td>
