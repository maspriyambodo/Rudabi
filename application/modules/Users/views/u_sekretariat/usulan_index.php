                ...
                <tbody>
                    ...
                    foreach ($usulan as $value) {
                        ...
                        <tr>
                            <td>
                                <?php
                                echo '<a href=' . base_url('Users/Sekretariat/Usulan/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $param[0] . '&b=' . $value->usul_propinsi . '&c=' . $value->propinsi_nama))) . '>' . $value->propinsi_nama . '</a>';
                                ?>
                            </td>
...
<script>
    function Tahun() {
        ...
        return window.location.href = "Users/Sekretariat/Usulan/index?key=" + a;
    }
