...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            <a href="<?= base_url('Users/Sekretariat/Input/index?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt($param[0]))); ?>" class="btn btn-light btn-shadow-hover"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
    </div>
    <div class="card-body">
            ...
            <table class="table table-bordered table-hover table-striped" style="width:100%;">
                ...
                <tbody>
                    ...
                    foreach ($input as $input_provinsi) {
                        ...
                        <tr>
                            <td>
                                <a href="<?= base_url('Users/Sekretariat/Input/Kabupaten?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $input_provinsi->kab_nama . '&b=' . $param[0] . '&c=' . $param[1] . '&d=' . $input_provinsi->usul_kabupaten . '&e=' . $param[2] . '')) . ''); ?>"><?php echo $input_provinsi->kab_nama; ?></a>
                            </td>
