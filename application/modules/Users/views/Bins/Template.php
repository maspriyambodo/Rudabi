            ...
            <div class="d-flex flex-row flex-column-fluid page">
                <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                    <div class="brand flex-column-auto" id="kt_brand">
                        <a href="<?= base_url('Users/Binsyar/Dashboard/index/'); ?>" class="brand-logo">
                        ...
                        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                            <ul class="menu-nav">
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="<?= base_url('Users/Binsyar/Dashboard/index/'); ?>" class="menu-link">
                                ...
                                <li class="menu-section">
                                    <h4 class="menu-text text-white user-select-none">SIHAT</h4>
                                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                                </li>
                                <div class="separator separator-dashed"></div>
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?= base_url('Users/Binsyar/Sihat/index/'); ?>" class="menu-link menu-toggle">
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?= base_url('Users/Binsyar/Ahli/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?= base_url('Users/Binsyar/Pengukuran/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?= base_url('Users/Binsyar/Lokasi/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?= base_url('Users/Binsyar/Laporan/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?= base_url('Users/Binsyar/Lintang/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-section">
                                    <h4 class="menu-text text-white user-select-none">simas</h4>
                                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                                </li>
                                <div class="separator separator-dashed"></div>
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?= base_url('Users/Binsyar/Simas/index'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?= base_url('Users/Binsyar/Mushalla/index'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?= base_url('Users/Binsyar/Tipologi/index'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?= base_url('Users/Binsyar/Tipologi/Mushalla/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
