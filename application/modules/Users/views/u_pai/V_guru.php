...
$e = 0; // tokoh_perempuan
$f = 0; // tokoh_kawin
$g = 0; // tokoh_belum_kawin
?>
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-2">
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Data Guru Ngaji</h5>
        </div>
    </div>
</div>
            ...
            <table class="table table-bordered table-hover table-striped" style="width:100%;">
                ...
                <tbody class="text-center">
                    ...
                    foreach ($a as $b) {
                        ...
                        $d += $b->tokoh_pria; // tokoh_pria
                        $e += $b->tokoh_perempuan; // tokoh_perempuan
                        $f += $b->tokoh_kawin; // tokoh_kawin
                        $g += $b->tokoh_belum_kawin; // tokoh_belum_kawin
                        ?>
                        <tr>
                            <td style="text-align: left !important;"><?php echo '<a href="' . base_url('Users/PAI/Guru_ngaji/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $b->province_id . '&b=' . $b->province_title))) . '" title="Detail Provinsi ' . $b->province_title . '">' . $b->province_title . '</a>'; ?></td>
                            <td><?php echo number_format($b->jum_tokoh); ?></td>
                            <td><?php echo number_format($b->tokoh_pria); ?></td>
                            <td><?php echo number_format($b->tokoh_perempuan); ?></td>
                            <td><?php echo number_format($b->tokoh_kawin); ?></td>
                            <td><?php echo number_format($b->tokoh_belum_kawin); ?></td>
                        </tr>
                    <?php } ?>
                </tbody>
...
<script>
    window.onload = function () {
        ...
        am4core.ready(function () {
            ...
            series.tooltipText = "Jumlah Guru Ngaji Provinsi {province_title}: [bold]{valueY}[/]";
