                    ...
                    foreach ($a as $b) {
                        ...
                        <tr>
                            ...
                            <td style="text-align: left !important;">
                                <?php echo '<a href="' . base_url('Users/PAI/Epai/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $b->provinsi_kode .'&b=' . $b->provinsi_nama))) . '" title="Detail Provinsi ' . $b->provinsi_nama . '">' . $b->provinsi_nama . '</a>'; ?>
                            </td>
                            <td>
