...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-2">
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Penyuluh Agama Islam Non-PNS</h5>
        </div>
    </div>
</div>
            ...
            <table class="table table-bordered table-hover table-striped" style="width:100%;">
                ...
                <tbody class="text-center text-uppercase">
                    ...
                    foreach ($a as $b) {
                        ...
                        ?>
                        <tr>
                            <td style="text-align:left !important;"><?php echo '<a href="' . base_url('Users/PAI/N_pns/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $b->penyuluh_nonpns_provinsi . '&b=' . $b->province_title))) . '" title="Detail Provinsi ' . $b->province_title . '">' . $b->province_title . '</a>'; ?></td>
                            <td><?php echo number_format($b->dt_nonpns); ?></td>
...
<input type="hidden" name="dt_nonpns" readonly="" value="<?php echo $c; ?>"/>
...
<script>
    window.onload = function () {
        var a, b, c, d, e;
        a = $('input[name="dt_nonpns"]').val();
        b = $('input[name="dt_laki"]').val();
        c = $('input[name="dt_perempuan"]').val();
        d = $('input[name="dt_kawin"]').val();
        e = $('input[name="dt_blmkawin"]').val();
        document.getElementById('title_chartdiv').innerText = "Total Data Penyuluh Non-PNS: " + numeral(a).format('0,0');
        am4core.ready(function () {
            ...
            series.dataFields.valueY = "dt_nonpns";
            series.dataFields.categoryX = "province_title";
            series.tooltipText = "Jumlah Penyuluh Non-PNS {province_title}: [bold]{valueY}[/]";
