...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            <a href="<?= base_url('Users/Sekertariat/Pegawai/index'); ?>" class="btn btn-light btn-shadow-hover"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
    </div>
    <div class="card-body">
...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            <p class="text-uppercase">data jenis kelamin & agama pegawai</p>
        </div>
    </div>
    <div class="card-body">
                    ...
                    <?php foreach ($pegawai as $pegawai) { ?>
                        <tr>
                            <td>
                                ...
                                echo '<a href="' . base_url('Users/Sekertariat/Pegawai/Kabupaten?key=' . $url) . '">' . $pegawai->kab_nama . '</a>';
                                ?>
                            </td>
