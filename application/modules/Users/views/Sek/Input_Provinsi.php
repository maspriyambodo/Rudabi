<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-2">
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5 text-uppercase">Input Usulan provinsi {provinsi} Tahun {tahun}</h5>
        </div>
    </div>
</div>
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            ...
            <a href="<?= base_url('Users/Sekertariat/Input/index/' . $url . ''); ?>" class="btn btn-light btn-shadow-hover"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
    </div>
    <div class="card-body">
                    ...
                    foreach ($input as $input_provinsi) {
                        ...
                        <tr>
                            <td>
                                ...
                                <a href="<?= base_url('Users/Sekertariat/Input/Kabupaten?param=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('kab_nama=' . $input_provinsi->kab_nama . '&usul_tahun=' . $tahun . '&usul_propinsi=' . $id . '&usul_kabupaten=' . $input_provinsi->usul_kabupaten . '&provinsi=' . $provinsi . '')) . ''); ?>"><?= $kab_nama; ?></a>
                            </td>
