...
<div class="card card-custom" data-card="true" id="kt_card_1">
    <div class="card-header">
        <div class="card-title">
            <a href="<?= base_url('Users/BKKS/Penilaian/index'); ?>" class="btn btn-light btn-shadow-hover"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
            ...
            <tbody>
                ...
                foreach ($taun as $value) {
                    ...
                    <tr>
                        ...
                        <td>
                            <?= '<a href="' . base_url('Users/BKKS/Penilaian/Kabupaten?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $param[0] . '&b=' . $value->kodekua . '&c=' . $value->propinsi))) . '">' . $value->propinsi . '</a>' ?>
                        </td>
                        <td class="text-center">
                            <?= $value->kodekua; ?>
                        </td>
