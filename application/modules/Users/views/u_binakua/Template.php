...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="https://simas.kemenag.go.id/assets/img/rudabilogo.png" />
        <?php if ($this->uri->segment(3) != "Dashboard") {echo '<meta http-equiv="refresh" content="30">';} else {echo '';}?>
        <title>{title}</title>
    </head>
                        ...
                        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                            <ul class="menu-nav">
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="<?= base_url('Users/BKKS/Dashboard/index/'); ?>" class="menu-link">
                                ...
                                <li class="menu-section">
                                    <h4 class="menu-text text-white user-select-none">BIMWIN</h4>
                                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                                </li>
                                <div class="separator separator-dashed"></div>
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?php echo base_url('Users/BKKS/Bimwin/index/'); ?>" class="menu-link menu-toggle">
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?php echo base_url('Users/BKKS/Catin/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?php echo base_url('Users/BKKS/Fasilitator/index/' . date("Y")); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-section">
                                    <h4 class="menu-text text-white user-select-none">e-Monev</h4>
                                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                                </li>
                                <div class="separator separator-dashed"></div>
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?php echo base_url('Users/BKKS/Emonev/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?php echo base_url('Users/BKKS/Tipologi/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?php echo base_url('Users/BKKS/Tanah/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?php echo base_url('Users/BKKS/Penilaian/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?php echo base_url('Users/BKKS/Rekap/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?php echo base_url('Users/BKKS/Isian/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?php echo base_url('Users/BKKS/Bangunan/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?php echo base_url('Users/BKKS/Simkah/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?php echo base_url('Users/BKKS/Registrasi/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="<?php echo base_url('Users/BKKS/KUA/index/'); ?>" class="menu-link">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="<?php echo base_url('Users/BKKS/Penghulu/index/'); ?>" class="menu-link">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="<?php echo base_url('Users/BKKS/Peristiwa/index/'); ?>" class="menu-link">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                        <span class="menu-text">Peristiwa Nikah</span>
                                    </a>
                                </li>
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="<?php echo base_url('Users/BKKS/Nikah_Rujuk/index/'); ?>" class="menu-link">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
