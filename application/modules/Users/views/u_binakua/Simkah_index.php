                ...
                <tbody class="text-center">
                    <?php foreach ($simkah as $value) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('Users/BKKS/Simkah/Detail?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $value->simkah . '&b=' . $value->kategori))); ?>" class="btn btn-icon btn-success btn-xs" title="Detail Kategori <?= $value->kategori ?>"><i class="fas fa-eye"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
