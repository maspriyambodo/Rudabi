                ...
                <tbody class="text-center">
                    <?php foreach ($tipo as $value) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('Users/BKKS/Tipologi/Tipokua?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $value->tipokua))); ?>" class="btn btn-icon btn-success btn-xs" title="Detail Tipologi KUA"><i class="fas fa-eye"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
