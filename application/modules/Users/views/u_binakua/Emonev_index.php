                    ...
                    <?php foreach ($kua as $key => $kua) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                echo '<a href="' . base_url('Users/BKKS/Emonev/Kankemenag?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $kanmenag[$key]->kodekab . '&b=' . $kua->propinsi))) . '">' . $kanmenag[$key]->jumlah_kabupaten . '</a>';
                                ?>
                            </td>
                            <td class="text-center">
                                <?php
                                $totjumlah_kua += $kua->jumlah_kua;
                                echo '<a href="' . base_url('Users/BKKS/Emonev/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $kua->kodekua . '&b=' . $kua->propinsi))) . '">' . $kua->jumlah_kua . '</a>'
                                ?>
                            </td>
                        </tr>
                    <?php } ?>
