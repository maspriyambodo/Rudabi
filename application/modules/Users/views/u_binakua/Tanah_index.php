                ...
                <tbody>
                    <?php foreach ($tanah as $dt_tanah) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?= base_url('Users/BKKS/Tanah/Statustanah?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $dt_tanah->statustanah . '&b=' . $dt_tanah->keterangan))); ?>" class="btn btn-icon btn-success btn-xs" title="Detail status bangunan KUA"><i class="fas fa-eye"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
