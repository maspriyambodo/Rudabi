                        ...
                        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                            <ul class="menu-nav">
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?php echo base_url('Users/Binsyar/Sihat/index/'); ?>" class="menu-link menu-toggle">
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?php echo base_url('Users/Binsyar/Ahli/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?php echo base_url('Users/Binsyar/Pengukuran/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?php echo base_url('Users/Binsyar/Lokasi/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?php echo base_url('Users/Binsyar/Laporan/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                <li class="menu-item menu-item" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="<?php echo base_url('Users/Binsyar/Lintang/index/'); ?>" class="menu-link menu-toggle">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
