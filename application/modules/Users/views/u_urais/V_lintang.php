...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-2">
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Data Lintang Kota</h5>
        </div>
    </div>
</div>
                ...
                <tbody class="text-center text-uppercase">
                    ...
                    foreach ($a as $b) {
                        ...
                        <tr>
                            ...
                            <td><?php echo '<a href="' . base_url('Users/Binsyar/Lintang/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $b->nama_propinsi . '&b=' . $b->province_title))) . '" title="Detail Provinsi ' . $b->province_title . '" class="btn btn-icon btn-default btn-xs"><i class="fas fa-eye"></i></a>'; ?></td>
                        </tr>
                    <?php } ?>
                </tbody>
