    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col bg-light-success px-6 py-8 rounded-xl mr-7 mb-7">
                <span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
                    <i class="fas fa-ruler-combined" style="font-size: 48px;"></i>
                </span>
        ...
        <div class="row">
            ...
            <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7 mb-7">
                <span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
                    <i class="far fa-compass" style="font-size: 48px;"></i>
                </span>
...
<div class="card card-custom" data-card="true" id="kt_card_1">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                <span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
                    <i class="fas fa-place-of-worship" style="font-size: 48px;"></i>
                </span>
