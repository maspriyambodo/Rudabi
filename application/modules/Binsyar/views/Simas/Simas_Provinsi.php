                    ...
                    foreach ($a as $b) {
                        ...
                        <tr>
                            <td style="text-align:left !important;">
                                <?= '<a href="' . base_url('Binsyar/Simas/Kabupaten?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $param[0] . '&b=' . $param[1] . '&c=' . $b->kabupaten_id . '&d=' . $b->kabupaten_name))) . '" title="Detail Provinsi ' . $b->kabupaten_name . '">' . $b->kabupaten_name . '</a>'; ?>
                            </td>
