...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-2">
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Data Masjid <?= $param[3] ?></h5>
        </div>
    </div>
</div>
<div class="card card-custom" data-card="true" id="kt_card_1">
    <div class="card-header">
        <div class="card-title">
            <a href="<?= base_url('Binsyar/Simas/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $param[0] . '&b=' . $param[1]))); ?>" class="btn btn-light btn-shadow-hover"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
            ...
            <table class="table table-bordered table-hover table-striped" style="width:100%;">
                ...
                <tbody class="text-center">
                    ...
                    foreach ($a as $b) {
                        ...
                        $l += $b->dt_negara; //dt_negara
                        $m += $b->dt_raya; //dt_raya
                        $n += $b->dt_agung; //dt_agung
                        $o += $b->dt_besar; //dt_besar
                        $p += $b->dt_jami; //dt_jami
                        $q += $b->dt_bersejarah; //dt_bersejarah
                        $r += $b->dt_publik; //dt_publik
                        $s += $b->dt_nasional; //dt_nasional
                        ...
                        <tr>
                            <td style="text-align:left !important;">
                                <?= '<a href="' . base_url('Binsyar/Simas/Kecamatan?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $param[0] . '&b=' . $param[1] . '&c=' . $param[2] . '&d=' . $param[3] . '&e=' . $b->kecamatan_id . '&f=' . $b->kecamatan_name))) . '" title="Detail Kecamatan ' . $b->kecamatan_name . '">' . $b->kecamatan_name . '</a>'; ?>
                            </td>
                            <td><?= $b->dt_masjid; ?></td>
                            <td><?= $b->dt_tanah; ?></td>
                            <td><?= $b->dt_bangunan; ?></td>
                            ...
                            <td><?= $b->dt_muazin; ?></td>
                            <td><?= $b->dt_remaja; ?></td>
                            <td><?= number_format($b->dt_negara); ?></td>
                            <td><?= number_format($b->dt_raya); ?></td>
                            <td><?= number_format($b->dt_agung); ?></td>
                            <td><?= number_format($b->dt_besar); ?></td>
                            <td><?= number_format($b->dt_jami); ?></td>
                            <td><?= number_format($b->dt_bersejarah); ?></td>
                            <td><?= number_format($b->dt_publik); ?></td>
                            <td><?= number_format($b->dt_nasional); ?></td>
                        </tr>
                    <?php } ?>
                </tbody>
