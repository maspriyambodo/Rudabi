                ...
                <tbody class="text-center text-uppercase">
                    ...
                    foreach ($a as $b) {
                        ...
                        <tr>
                            ...
                            <td><?php echo '<a href="' . base_url('Binsyar/Lintang/Provinsi?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $b->nama_propinsi . '&b=' . $b->province_title))) . '" title="Detail Provinsi ' . $b->province_title . '" class="btn btn-icon btn-default btn-xs"><i class="fas fa-eye"></i></a>'; ?></td>
                        </tr>
                    <?php } ?>
                </tbody>
