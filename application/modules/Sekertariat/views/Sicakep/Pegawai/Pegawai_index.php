...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-2">
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Data Pegawai Berdasarkan Provinsi</h5>
        </div>
    </div>
</div>
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            <p class="text-uppercase">data pegawai daerah tingkat provinsi</p>
        </div>
    </div>
    <div class="card-body">
...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            <p class="text-uppercase">detail data pegawai</p>
        </div>
    </div>
    <div class="card-body">
                ...
                <tbody>
                    <?php foreach ($pegawai as $pegawai) { ?>
                        <tr>
                            <td>
                                <?php
                                $url = str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $pegawai->propinsi_nama . '&b=' . $pegawai->peg_provinsi));
                                echo '<a href="' . base_url('Sekertariat/Sicakep/Pegawai/Provinsi?key=' . $url) . '">' . $pegawai->propinsi_nama . '</a>';
                                ?>
                            </td>
