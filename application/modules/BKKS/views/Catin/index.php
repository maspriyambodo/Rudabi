                    ...
                    foreach ($a as $b) {
                        ...
                        <tr>
                            <td style="text-align:left !important;">
                                <?php
                                echo '<a href="' . base_url('BKKS/Catin/Tahun?key=' . str_replace(['+', '/', '='], ['-', '_', '~'], $this->encryption->encrypt('?a=' . $b->tahun_target_wilayah))) . '" title="Target Catin Tahun ' . $b->tahun_target_wilayah . '">' . $b->tahun_target_wilayah . '</a>';
                                ?>
                            </td>
